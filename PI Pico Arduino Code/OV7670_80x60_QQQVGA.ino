...
Purpose Of Code:   Writing and reading camera data from a FIFO using a PI Pico or an RP2040 based board and sends the data to Processing running on Mac or PC.
*/
